            ...
            <div class="services-item mt-30">
               ...
               <div class="services-content">
                  ...
                  <p>
                     ...
                     <a href="#" class="see-more">{{__('se more')}}...</a>
                     @else
                     {{$service->summary}}
                     @endif
                  </p>
...
<!-- pricing begin -->
<div class="pricing-tables" style="background: antiquewhite;">
   <div class="container">
      <div class="row text-center">
         <div class="col-lg-6 offset-lg-3">
      ...
      <div class="pricing-carousel common-carousel owl-carousel owl-theme">
         ...
         <div class="single-pricing-table">
            <i class="fa fa-house-chimney fa-4x" style="margin-top: -3rem"></i>
            ...
            <a href="{{route('front.packageorder.index', $package->id)}}" class="pricing-btn">{{__('Know in Detail')}}</a>
            @endif
...
<div class="container ">
   <div class="container">
      ...
      Why Choose Royallinks?
      </h2>
   </div>
   <div class="row" style="text-align: center;">
      <div class="col-xs-6  col-lg-4 col-md-4 col-sm-6 wow fadeIn"">
            <div class=" box">
         <div class=" img-box">
         <i class="fa fa-screwdriver-wrench fa-4x" style="margin: 2rem; color:red;"></i>
         </div>
  ...
  <a href="#"><button class="knowMore-btn">Know More</button></a>
</div>
</div>
<!--Why Choose Us End-->
