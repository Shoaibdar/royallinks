<script src="https://kit.fontawesome.com/df227acd88.js" crossorigin="anonymous"></script>
@php
       ...
       <div class="col-lg-10 col-6 {{$rtl == 1 ? 'text-left' : 'text-right'}} position-static">
          <ul class="main-menu" id="mainMenu">
             ...
             <i class="fa fa-phone" style="color: red"></i>
                <b style="color: red">+91 9999-99-99-99</b>
               <!-- <a href="{{route('front.quote')}}" class="boxed-btn">{{__('Request A Quote')}}</a> -->
            </li>
             @endif
          </ul>
